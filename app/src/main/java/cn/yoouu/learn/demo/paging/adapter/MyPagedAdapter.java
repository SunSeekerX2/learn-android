package cn.yoouu.learn.demo.paging.adapter;
...
public class MyPagedAdapter extends PagedListAdapter<Student, MyPagedAdapter.MyViewHolder> {
  ...
  public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    View view = inflater.inflate(R.layout.demo_paging_list_cell, parent, false);
  ...
  static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(@NonNull View itemView) {
      super(itemView);
      textView = itemView.findViewById(R.id.demoPagedListCellTextView);
    }
  }
}
